...
public interface EnrollmentRepository extends JpaRepository<Enrollment, UUID> {
    ...
    @Query("SELECT e FROM Enrollment e JOIN FETCH e.student WHERE e.course.id IN :courseIds")
    List<Enrollment> findAllByCourseIdsWithStudent(@Param("courseIds") List<UUID> courseIds);
}
